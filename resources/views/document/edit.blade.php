    ...
    <div class="card-body">
        ...
        <form class="form-horizontal" method="post" action="{{ route('document.update',[$document->id]) }}"
            ...
            <div class="form-group">
                ...
                <textarea id="deskripsi_dokumen" name="deskripsi_dokumen" value="{{$document->deskripsi_dokumen}}" class="form-control" cols="30"
                    rows="10"></textarea>
            </div>
            
                <label for="file" class="col-sm-2 control-label"></label>
                <div class="col-sm-10">
                    <iframe src="{{ asset('uploads/'.$document->file) }}" width="500" height="250"></iframe>
