                  ...
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $row->kategori }}</td>
                            <td>{{ $row->jumlah_dokumen }}</td>
                            <td>{{ $row->jumlah_like }}</td>
                            <td>{{ $row->jumlah_view }}</td>
                            ...
                            <td>
                               <form method="post" action="{{ route('kategori.destroy',[$row->id_kategori]) }}"
                                    ...
                                    @csrf
                                    {{ method_field('DELETE') }}
                                <a href="" data-target="#modal-default2-{{$row->id_kategori}}" data-toggle="modal" type="button" class="btn btn-round btn-warning btn-md far fa-edit"></span></a>
