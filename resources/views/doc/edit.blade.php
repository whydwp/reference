...
<div class="col-md-12">
    ...
    <div class="card-body">
        ...
        <form class="form-horizontal" method="post" action="{{ route('doc.update',[$document->id]) }}" enctype="multipart/form-data">
            @csrf
            {{ method_field('PUT') }}
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <select id="id_kategori" name="id_kategori" class="form-control @error('id_kategori') is-invalid @enderror">      
                           <option disabled style="font-weight: bold;">Teknis : </option>
            ...
            <div class="form-group">
                ...
                <textarea name="deskripsi_dokumen"  class="form-control @error('deskripsi_dokumen') is-invalid @enderror" cols="30"
  ...
  <hr>
            ...
            <hr>
                ...
                <div class="col-sm-12 embed-responsive embed-responsive-4by3">
                    ...
                    @else
                    <img class="embed-responsive-item" src="{{ asset('image/Picture1.png') }}" class="img-thumbnail" width="80%">
                    @endif
                </div>
            <div class="row">
                <div class="col-sm-12">
