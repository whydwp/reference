...
<body id="mimin" class="dashboard">
      ...
      <div class="navbar-header" style="width:100%;">
        ...
        <ul class="nav navbar-nav navbar-right user-nav">
          ...
          <li class="dropdown avatar-dropdown">
            ...
            <ul class="dropdown-menu user-dropdown">
              <li><a href="{{route('general2.profil')}}"><span class="fa fa-user"></span> My Profile</a></li>
  ...
  <div class="container-fluid mimin-wrapper">
    ...
    <div id="ascrail2000" class="nicescroll-rails"
      style="width: 7px; z-index: 222; cursor: default; position: fixed; top: 50px; left: 0px; height: 949px; display: none; opacity: 0;">
      <div
        style="position: relative; top: 0px; float: right; width: 5px; height: 949px; background-color: rgb(33, 150, 243); border: 1px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 5px;">
      </div>
    </div>
    <div id="ascrail2000-hr" class="nicescroll-rails"
      style="height: 7px; z-index: 222; top: 992px; left: 0px; position: fixed; cursor: default; display: none; width: 0px; opacity: 0;">
      <div
        style="position: relative; top: 0px; height: 5px; width: 194px; background-color: rgb(33, 150, 243); border: 1px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 5px; left: 0px;">
      </div>
    </div>
