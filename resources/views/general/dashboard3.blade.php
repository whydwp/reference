    ...
    <!-- <div id="left-menu">
        ...
        <ul class="nav nav-list">
            ...
            <li class="active ripple">
                <a href="{{ route('dashboard') }}" class="tree-toggle nav-header"><span class="fa-home fa"></span> Dashboard
                </a>
            </li>
            <li class="ripple">
            ...
            <li class="ripple">
                <a href="{{ route('kelola-user') }}" class="tree-toggle nav-header">
    ...
    <!-- <div id="left-menu"> -->
              <div class="sub-left-menu scroll">
                <ul class="nav nav-list">
                    ...
                    <li><a href="{{route('kelola-user')}}">Kelola User</a></li>
                    <li><a href="">Profil</a></li>
                    <li><a href="">My References</a></li>
                    <li><a href="">My Likesl</a></li>
                    <li><a href="">Kelola DOkumen</a></li>
                    
                    <!-- <li class="active ripple"> -->
                    <li class="ripple">
                      <a class="tree-toggle nav-header"><span class="fa-home fa"></span> Kategori 
                        <span class="fa-angle-right fa right-arrow text-right"></span>
                      </a>
                      <ul class="nav nav-list tree">
                          <li><a href="">Kategori 1</a></li>
