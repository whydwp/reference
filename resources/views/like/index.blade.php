    ...
    <div class="col-md-12">
        <div class="col-md-12 tabs-area box-shadow-none">
            <div role="tabpanel" class="tab-pane fade active in" id="tabs-demo7-area2"
                ...
                <i class="fa fa-thumbs-up mr-2" style="color: #1E88EE;font-size: 35px;vertical-align: middle;"
                    aria-hidden="true"></i> My Likes
                <span style="font-weight: 400;float: right;font-size: 15px;vertical-align: middle;">
                    <span style="color: #107fe4;"><span id="in_likes">5</span> Files</span>
            </div>
            <div class="media">
