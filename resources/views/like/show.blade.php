...
@section('titlel')
<a href="{{route('like.index')}}"> Reference </a> / Baca dokument
@endsection
    ...
    <div class="col-md-12">
        <div class="list-group">
            <div class=" card list-group-item">
                <a href="{{route('like.index')}}" class="btn btn-info btn-xl"><i
                ...
                <div class="row">
                    <div class="container">
                        <div class="col-md-12">
                            ...
                            <label style="text-align:center; font-size:40px;" for="file"
                                class=" col-sm-12 control-label">{{$reference->judul_dokumen}}</label>
                    ...
                    <div class="col px-4">
                        ...
                        <div>
                            ...
                            <a class="tahun" style="color : #aaa !important;" href=""> | Create :
                                {{$reference->tahun}}</a>
                            <div class="float-right">
                                <h5 id="id_kategori" name="id_kategori">Kategori : {{$reference->kategori->kategori}}
                                </h5>
                            </div>
                        </div>
                        <br>
                                    ...
                                    <form method="post" action="{{ route('reference.destroy',[$item->id]) }}"
                                        ...
                                        <div class="direct-chat-msg">
                                            <div class="direct-chat-infos clearfix" id="comment_{{ $item->id }}">
                                                <span
                                                    class="direct-chat-name float-left">{{$item->user->full_name}}</span>
                                                ...
                                                @endif
                                                <span
                                                    class="direct-chat-timestamp float-right">{{$item->created_at}}</span>
                                            </div>
